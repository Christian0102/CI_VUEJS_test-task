...
<body>
  <div id="app">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <li class="nav-item">
            ...
            <a href="/main_page/logout" class="btn btn-primary my-2 my-sm-0" data-target="#loginModal">Log out,
              <?= $user->personaname?>
            </a>
            <? } else {?>
            ...
            <div class="col-4" v-for="post in posts" v-if="posts">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-outline-success my-2 my-sm-0" @click="openPost(post.id)">Open
                    post
                  </button>
                </div>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-4" v-for="box in packs" v-if="packs">
                <div class="card">
                  <img :src="'/images/box.png' + '?v=<?= filemtime(FCPATH . '/js/app.js') ?>'" class="card-img-top"
                    alt="Photo">
                  <div class="card-body">
                    <button type="button" class="btn btn-outline-success my-2 my-sm-0" @click="buyPack(box.id)">Buy
                      boosterpack {{box.price}}$
                    </button>
                  </div>
                </div>
              </div>
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="inputEmail" aria-describedby="emailHelp" v-model="login"
                  required>
    ...
    <div class="modal fade bd-example-modal-xl" id="postModal" tabindex="-1" role="dialog"
      aria-labelledby="exampleModalLabel" aria-hidden="true" v-if="post">
          ...
          <div class="modal-body">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
               ...
               <!-- <p class="card-text" v-if="commentText.length" v-for="(item, index) in commentText" :key="index"> 
                  <div v-text="item.text">
                  </div>
                </p>-->

                <div v-if="commentText.length" >
                  <div v-for="(item, index) in commentText">
                    <div :class="'block_' + item.depth">
                      {{item.text}}
                        <div class="user-name-comment" v-text="item.userName">
